...
- 커밋 `a559967` push → Vercel 프리뷰 배포 자동 트리거 → **success(● Ready)** 확인
- 프리뷰 URL: https://y-os-core-6wf772fhb-project-hosting-center.vercel.app (한글 브랜치라 해시 기반 URL — docs/6 추록과 동일 동작, SSO 보호)
- PR: https://github.com/Y-ONE-soft/y-os-core/pull/3 — merge commit 방식으로 머지
