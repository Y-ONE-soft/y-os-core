...
- 커밋 `3546e1e` push → Vercel 프리뷰 배포 자동 트리거 → **success(● Ready)** 확인
- 프리뷰 URL: https://y-os-core-j8co73kmw-project-hosting-center.vercel.app (한글 브랜치 해시 URL, SSO 보호 — docs/6 추록과 동일 동작)
- PR: https://github.com/Y-ONE-soft/y-os-core/pull/4 — merge commit 방식으로 머지
- **docs 번호 충돌 규칙 첫 실제 적용**: 이 문서가 7 → 9로 조정된 경위는 문서 상단 "번호 조정" 참고
